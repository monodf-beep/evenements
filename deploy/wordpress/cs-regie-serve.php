...
Description: Affiche les pubs manuelles depuis {backoffice}/api/active-ads (Bloc 3,
  ...
  ⚠️ Récupéré depuis wp-content/mu-plugins/ en production le 2026-07-18 : ce fichier
  existait déjà en LIVE, jamais commité ici auparavant (voir docs/REGIE_MISE_EN_PLACE_SOCLE.md,
  conflit #2). Testé le même jour : https://backoffice.agendasabauda.eu/api/active-ads
  time-out — le bandeau ne s'affiche donc jamais actuellement (fail-safe silencieux,
  aucun crash, juste rien de rendu). À réconcilier avec le Bloc 3 Ad Inserter du socle,
  qui fait doublon sur le même emplacement.
*/
