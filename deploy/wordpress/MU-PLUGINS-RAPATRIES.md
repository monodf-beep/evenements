...
- `cs-yoast-scores.php` — NEUF le 16/09/2026, déposé depuis le dépôt (v1.0 md5 `36e037dadeaee5b6ea6b1ca4c215591c`, 9 878 octets ; v1.1 le soir même, md5 `408d559355ab30234688c7579e792538`, 11 347 octets, sauvegarde `.bak-2026-09-16` à côté ; v1.2 le 17/09 à 00h30, md5 `7603fa280fb508842bc588b857ebde6b`, 12 676 octets, sauvegarde `.bak-2026-09-17` ; v1.3 le 17/09 à 12h30, md5 `4127499d72c9d64fa70d9306ac49176b`, 13 433 octets, sauvegarde `.bak-2026-09-17-v12` ; v1.4 le 17/09 à 13h30, md5 `6693f62619a8bf944ab47527cfe84a5f`, 13 807 octets, sauvegarde `.bak-2026-09-17-v13`), jamais écrit sur le serveur à la main. Voir docs/DEPLOIEMENT_WORDPRESS.md.
