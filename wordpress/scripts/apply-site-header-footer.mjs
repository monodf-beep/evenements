#!/usr/bin/env node
/**
 * apply-site-header-footer.mjs — Pousse le snippet PHP qui injecte un header et
 * un footer de marque sur toutes les pages (sauf Accueil, 928, qui a les siens).
 * Voir wordpress/design-system/site-header-footer.php.
 *
 * Usage : node wordpress/scripts/apply-site-header-footer.mjs
 */
...
const NAME = 'CS · Header/Footer de marque (site-wide)';
...
async function main() {
  const php = readFileSync(join(REPO, 'wordpress', 'design-system', 'site-header-footer.php'), 'utf8')
    .replace(/^<\?php\s*/, '');
