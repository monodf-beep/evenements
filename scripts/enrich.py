...
def enrich_event(ev: dict, material: str, client: anthropic.Anthropic, model: str,
    ...
    if _court:
        # 120-200 → 180-220 mots le 09/09 : un « petit événement » est publié comme les
        # autres (WP#2234 : 90 mots en ligne), le plancher de 200 vaut donc ici aussi. Le
        # mode court reste moins cher par l'absence de recherche web et COURT_MAX_TOKENS.
        prompt += ("\n\n[MODE COURT — petit événement] BREF mais pas maigre (180-220 mots, 1-2 "
