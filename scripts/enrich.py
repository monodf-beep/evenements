...
{{
  ...
  "article": {{
    ...
    "corps": "<le savoir transmis, le regard ; relie le territoire et au-delà. MARKDOWN structuré pour la lisibilité (Yoast) : si le corps dépasse ~250 mots, découpe-le avec des sous-titres '## ' tous les 2-3 paragraphes ; phrases COURTES (vise <20 mots) ; enchaîne naturellement, SANS transitions scolaires ni connecteurs clichés (cf. voix). GRAS UTILE mais PARCIMONIEUX : mets en gras 1 à 2 expressions VRAIMENT structurantes sur TOUT l'article (le concept-clé, l'angle éditorial, un mot-pivot de chapitre) pour guider l'œil du lecteur pressé, JAMAIS sur les noms propres, lieux, dates ou chiffres (déjà dans l'encadré natif). Jamais plus de 2 sur tout l'article. N'utilise PAS le tiret cadratin (— ou –), signature d'écriture IA : préfère la virgule, la parenthèse, le deux-points ou le point. Français soigné, aucun anglicisme (écris « programmes », pas « programs »). N'écris PAS d'encadré pratique dans le corps (dates/lieu/tarif) : le site l'affiche déjà nativement, le corps reste ÉDITORIAL>",
