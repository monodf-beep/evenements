...
def web_venue(ev: dict, client) -> tuple[str, str, str]:
    ...
    prompt = (
        "Tu identifies le LIEU EXACT (salle, site, château, place…) et la VILLE où se "
        "déroule un événement culturel. UTILISE la recherche web pour vérifier — ne "
        "devine JAMAIS. Ne réponds « found: true » QUE si une source fiable (site "
        "officiel, billetterie, presse) confirme le lieu.\n\n"
