...
## 1. Les gentilés — nommer les gens et les lieux
...
| Piémont | **piémontais·e** | *piemontese*, *piemontèis* | accent aigu |
| Vallée d'Aoste | **valdôtain·e** | *valdostano* (it.) | **circonflexe ô** ; jamais « aostois » |
| Nice / comté de Nice | **niçois·e** | *niçard/nissart* (langue), *nizzardo* (it.) | voir ci-dessous |

**Le cas niçois (piège central).** Les habitants = **niçois**. *Niçard / nissart* désignent d'abord **la langue** (occitan de Nice) et le fait culturel militant ; à réserver au registre culturel. *Nizzardo* = graphie italianisante, pour contextes italiens/historiques. → **Habitants : niçois. Langue et culture propre : nissart/niçard.**

**Orthographe non négociable :** Valdôtain (ô) · Mauriennais (nn) · Tarin (≠ tarentais) · Haut-Savoyard (trait d'union).

---

## 2. Nommer qui s'est installé — le cas « néo- »

**Correction de doctrine.** « Néo-savoyard », « néo-valdôtain » **ne sont pas des gentilés attestés**, et le préfixe *néo-* (calqué sur « néo-rural », terme de sociologie) porte une **nuance d'extériorité** — « pas vraiment d'ici » — qui contredit l'esprit d'appartenance. L'intuition (nommer par le territoire celui qui s'y est enraciné) est juste ; le véhicule « néo- » est mauvais.

| Registre | Formule juste |
|---|---|
| Attachement, intégration ancienne | **savoyard·e / valdôtain·e d'adoption** (attesté, réciproque) |
| Neutre, factuel | **installé·e en Maurienne depuis…**, **établi·e à Aoste** |
| Affectif, portrait/chronique | **savoyard·e / piémontais·e de cœur** |

Quand l'origine réelle est introuvable après recherche : décrire le fait vérifiable (« basé à Turin ») et le porter en point **« à vérifier »** — jamais inventer une nationalité.
...
- **Nissart / ligure** — le nissart (occitan de Nice, teinté de ligure) marque le comté de Nice ; le ligure relie la Riviera aux vallées occitanes du Piémont.
...
- **« Transfrontalier »** au sens *coopération qui relie deux versants* (ALCOTRA, Interreg) — **à distinguer de « transalpin »** (qui pose les Alpes en barrière). Nuance : voir §8.

---

## 5. ❌ Tournures à PROSCRIRE → par quoi remplacer

### a) Nationalisation française
...
### b) Nationalisation italienne / irrédentisme (**aussi grave**)
| ❌ | Pourquoi | ✅ Remplacer par |
|---|---|---|
| « Savoia italiana », « Nizza italiana », « terre irredente » | irrédentisme : territoire « à récupérer » | « identità territoriale sabauda », « Contea di Nizza », « Paese nizzardo » |
| « il suo cuore batte ancora italiano » | sentimentalisme national | « radici nizzarde e liguri-piemontesi vive » |
| « ceduta / tradita / sacrificata alla Francia », « colonia » | récit victimaire-national | fait neutre : « il trattato di Torino del 1860 », « le proteste savoiarde » |
...
- **Résidences royales de la Maison de Savoie** (UNESCO) — patrimoine matériel partagé, de Turin à Chambéry et Nice.
- **Institutions vivantes** — Acadèmia Nissarda, Ciamada Nissarda (1925), Félibrige, Fondation Chanoux, Musée Savoisien (récit croisé Savoie–Aoste–Piémont).

---

## 7. Table de substitution rapide — « au lieu de X → dire Y »
...
| la France / les Français (vus d'ici) | **au-delà du Var** (de Nice) · **au-delà du Rhône** (de Savoie) — marqueur-maison à **gloser la 1ʳᵉ fois**. Éviter *oltralpe* (= mot-frontière) |
| la relation **interne** Savoie ↔ Piémont | **deçà / delà les monts** (attesté) — *« ni en deçà ni au-delà, mais entre les monts »* |
