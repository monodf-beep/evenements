...
- **Slug** : `ou-manger-a-turin-mangebin`
- **Titre SEO** : Où manger à Turin : les 64 tables du label Mangébin
- **Méta-description** : Le label Mangébin réunit 64 tables où manger à Turin et dans sa province. Ce qu'il garantit, ce qu'il ne dit pas, sept adresses.
- **Alt de l'image à la une** : Devanture d'une piola turinoise, où manger à Turin la cuisine piémontaise
- **Jumelle IT** : `/it/dove-mangiare-a-torino-mangebin/`, à apparier dans Polylang

---

## Corps de l'article

# Où manger à Turin : les tables Mangébin
