# Règle canonical — Cultura Sabauda ↔ Agenda Sabaudo
...
- **Agenda Sabaudo** (site de volume) : fiche factuelle, tous les événements.
...
éditoriale, à plus forte autorité). La fiche Agenda Sabaudo pointe alors un `rel=canonical` vers
l'URL Cultura Sabauda.

| Où est l'événement | `rel=canonical` de chaque page |
|---|---|
| Seulement sur Cultura Sabauda | CS → elle-même (défaut) |
| Seulement sur Agenda Sabaudo | Agenda → elle-même (défaut) — **le cas majoritaire** (score < 7) |
...
- **Demain (export Agenda Sabaudo, à construire)** : dans le publisher Agenda, si l'événement a
...
Le site Agenda Sabaudo peut se construire sans canonical dans un premier temps (peu
